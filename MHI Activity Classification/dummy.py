...
class MHIKnn():
    ...
    def leave_one_out(self):
        ...
        for i in range(len(self.train_data)):
            j = list(range(0, i)) + list(range(i+1, self.train_data.shape[0]))
            # train dataset
            ...
            retval, res, neighborResponses, dists = self.classifier.findNearest(Xte, 1)
